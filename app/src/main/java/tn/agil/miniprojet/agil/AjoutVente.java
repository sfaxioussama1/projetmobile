...
public class AjoutVente extends AppCompatActivity {
    ...
    String showUrl="http://192.168.1.5:81/WebService1/ajoutVente.php";
    String recupProduitUrl="http://192.168.1.5:81/WebService1/listeproduit.php";
    String recupStationUrl="http://192.168.1.5:81/WebService1/listestation.php";
    String recupPromoUrl="http://192.168.1.5:81/WebService1/listepromotion.php";
